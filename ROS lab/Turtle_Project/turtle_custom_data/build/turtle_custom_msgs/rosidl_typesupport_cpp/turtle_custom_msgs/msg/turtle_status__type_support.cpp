...
static const _TurtleStatus_type_support_symbol_names_t _TurtleStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_custom_msgs, msg, TurtleStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_custom_msgs, msg, TurtleStatus)),
  }
};
...
{
  return &::turtle_custom_msgs::msg::rosidl_typesupport_cpp::TurtleStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtle_custom_msgs, msg, TurtleStatus)() {
  return get_message_type_support_handle<turtle_custom_msgs::msg::TurtleStatus>();
}

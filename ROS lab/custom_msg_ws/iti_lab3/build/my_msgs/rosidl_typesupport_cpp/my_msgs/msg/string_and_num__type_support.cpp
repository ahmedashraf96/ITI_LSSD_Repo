...
static const _StringAndNum_type_support_symbol_names_t _StringAndNum_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_msgs, msg, StringAndNum)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_msgs, msg, StringAndNum)),
  }
};
...
{
  return &::my_msgs::msg::rosidl_typesupport_cpp::StringAndNum_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_msgs, msg, StringAndNum)() {
  return get_message_type_support_handle<my_msgs::msg::StringAndNum>();
}
